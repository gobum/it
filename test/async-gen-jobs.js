...
var t = 1;
it("g1", async function* () {
  it("g1.g1", async function* () {
    it("g1.g1.g1", async function* () {
  ...
  it("g1.g2", async function* () {
    it("g1.g2.g1", async function* () {
  ...
  it("g1.g3", async function* () {
    it("g1.g3.g1", async function* () {
